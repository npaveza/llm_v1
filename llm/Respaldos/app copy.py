...
class MemoryModule:
    ...
    def __init__(self, memory_file="tony_memory.json"):
...
class InteractiveTrainerWithReasoning:
    ...
    def __init__(self, model_name='DeepESP/gpt2-spanish', output_dir='./Tony', learning_rate=2e-5, batch_size=4, num_epochs=1, weight_decay=0.01):
    ...
    def add_interaction(self, prompt, response):
        ...
        # Guardar la interacción en el archivo JSON y la memoria persistente
        self.save_dataset()
        self.memory.add_memory(prompt, response)
...
if __name__ == "__main__":
    ...
    interactive_trainer = InteractiveTrainerWithReasoning(
        model_name="DeepESP/gpt2-spanish",  # Cambiado a "DeepESP/gpt2-spanish" para usar un modelo más liviano
        output_dir='./Tony',
        learning_rate=3e-5,
        batch_size=2,
        num_epochs=1,
